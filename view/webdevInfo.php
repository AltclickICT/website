...
<head>
    ...
    <title>Web Development Classes</title>
...
<body>
        ...
        <section id="about" class="about" style="margin-top: 100px;">
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-header">
                    ...
                    <h2><strong>Why Choose Our Web Design Classes?</strong></h2>
    ...
    <ul style="list-style-type: none;">
        ...
        <li><p>Remote Classes: ₦130,000 </p></li>
        <li><p>Private Lessons: ₦200,000 </p></li>
    </ul>
