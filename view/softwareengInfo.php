...
<head>
    ...
    <title> Software Engineer Classes </title>
        ...
        <section id="about" class="about" style="margin-top: 100px;">
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-header">
                    ...
                    <h2><strong>Embark on a Journey to Become a Software Engineer</strong></h2>

    <p>Join our software engineer classes and dive deep into the world of software development, algorithms, and problem-solving.</p>
