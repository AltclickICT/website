...
<head>
    ...
    <title>Business & Enterpreneurship in IT</title>
        ...
        <section id="about" class="about" style="margin-top: 100px;">
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-header">
                    ...
                    <h2><strong> Business & Enterpreneurship in IT Classes</strong></h2>

   
    <h2><strong>Who Can Benefit?</strong></h2>

    <p>Anyone with a passion for making Money in the ever evolvin tech echo system.</p>

    <h2><strong> What You Will Learn </strong></h2>

    <ul style="list-style-type: none;">
        <li><p> Copy Writting</p></li>
        <li><p> Digital Marketing </p></li>
        <li><p> Transcription </p></li>
        <li><p> Data Entry </p></li>
        <li><p> Data Extraction </p></li>
        <li><p> Virtual Assistance </p></li>
