...
<body>
    ...
    <p>Our elite team of instructors will lead you through a thrilling curriculum, immersing you in the world of robotics and equipping you with the skills for future innovations.</p>
    <h2><strong>Who Can Benefit?</strong></h2>

    <p>Our classes are the ultimate battleground for tech-savvy heroes, future innovators, and anyone passionate about robotics.</p>

    <h2><strong> What You Will Learn </strong></h2>

    <ul style="list-style-type: none;">
        <li><p>Mechanical Design</p></li>
        <li><p> Electrical Systems</p></li>
    ...
    <ul style="list-style-type: none;">
        <li><p>Onsite Classes: ₦400,000 </p></li>
        <li><p>Remote Classes: ₦350,000 </p></li>
