...
<head>
    ...
    <title>UI/UX Designer Classes</title>
        ...
        <section id="about" class="about" style="margin-top: 100px;">
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-header">
                    ...
                    <h2><strong>Unleash Your Creativity as a UI/UX Designer</strong></h2>

    <p>Join our UI/UX designer classes and embark on a journey to craft intuitive, user-centric digital experiences.</p>

    <h2><strong> Why Choose Our UI/UX Designer Classes? </strong></h2>
...
<p>3 months + 1 Months Internship</p>
    ...
    <ul style="list-style-type: none;">
        <li><p>Onsite Classes: ₦150,000 </p></li>
