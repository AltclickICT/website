...
<head>
    ...
    <title>Networking Classes</title>
...
<body>
    ...
    <ul style="list-style-type: none;">
        ...
        <li><p> Network Classification </p></li>
        <li><p> Network Topologies </p></li>
        <li><p> Basic Admin. Network Modules </p></li>
        <li><p> Client/Server Network </p></li>
        <li><p> Peer to Peer Network </p></li>
        <li><p> Network Os </p></li>
        <li><p> Toubleshooting </p></li>
    </ul>
