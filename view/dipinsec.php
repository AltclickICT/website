...
<body>
        ...
        <section id="about" class="about" style="margin-top: 100px;">
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-header">
                    ...
                    <h2><strong> Diploma in Sec Classes</strong></h2>
    ...
    <ul style="list-style-type: none;">
        ...
        <li><p> Presentation (Powerpoint) </p></li>
        <li><p> Spreadsheet (Excel) </p></li>
        <li><p> Graphics Design (Corel Draw) </p></li>
        <li><p> Scanning </p></li>
        <li><p> Office Network </p></li>
        <li><p> Communication Skills </p></li>
        <li><p> Internet Skills </p></li>
    </ul>
