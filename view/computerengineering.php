...
<head>
    ...
    <title>Computer Engineering Classes</title>
...
<body>
        ...
        <section id="about" class="about" style="margin-top: 100px;">
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-header">
                    ...
                    <h2><strong> Computer Engineering Classes</strong></h2>

   
    <h2><strong>Who Can Benefit?</strong></h2>

    <p>Our classes are the ultimate battleground for tech-savvy heroes, future ethical hackers, innovators and anyone passionate about safeguarding the digital frontier.</p>

    <h2><strong> What You Will Learn </strong></h2>

    <ul style="list-style-type: none;">
        <li><p>Basic System Component</p></li>
        <li><p> System Troubleshooting </p></li>
        <li><p> System Maintanance </p></li>
        <li><p> Bios Configuration </p></li>
        <li><p> Formatting/Installation </p></li>
        <li><p> Coupling/System Assembling </p></li>
        <li><p> Internet </p></li>
    ...
    <ul style="list-style-type: none;">
        <li><p>Onsite Classes: ₦75,000 </p></li>
    </ul>
