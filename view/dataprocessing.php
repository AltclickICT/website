...
<head>
    ...
    <title>Data Processing Classes</title>
...
<body>
        ...
        <section id="about" class="about" style="margin-top: 100px;">
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-header">
                    ...
                    <h2><strong>Come and Experience Our Diploma in Data Processing Classes</strong></h2>

    <p>Learn from expert instructors, explore a comprehensive curriculum, and gain hands-on experience.</p>

    <h2><strong> Why Choose Our Data Processing Classes?</strong></h2>
    ...
    <ul style="list-style-type: none;">
        ...
        <li><p> Presentation (Power-Point) </p></li>
        <li><p> Spreadsheet (Excel) </p></li>
        <li><p> Graphics Design: Corel Draw & Photoshop </p></li>
        <li><p> Basic Printing Techniques </p></li>
