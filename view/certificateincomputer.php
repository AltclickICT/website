...
<head>
    ...
    <title> Certificate In Computer </title>
        ...
        <section id="about" class="about" style="margin-top: 100px;">
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-header">
                    ...
                    <h2><strong>Embark on a Journey to Become a Certified Computer Operator</strong></h2>

    <p>Join our Certificate in Computer classes and dive deep into the world of computers, operating systems, and system applications.</p>

    <h2><strong> Who Can Benefit? </strong></h2>

    <p>Anybody with a passion for learning and computers.</p>

    <h2><strong> What You Will Learn </strong></h2>

    <ul style="list-style-type: none;">
        <li><p>Intro to Computer</p></li>
        <li><p> Intro to OPerating Systems </p></li>
        <li><p>Word Processing (Ms. Word)</p></li>
        <li><p> Spreadsheet (Ms. Excel) </p></li>
        <li><p>Presentation Package (Power-Point)</p></li>
        <li><p> Typing Tutorials</li>
        <li><p>Graphics Design (Corel Draw)</p></li>
        <li><p> Internet Basics </p></li>
    </ul>
