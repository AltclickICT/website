...
<head>
    ...
    <title>API Building and Implementation Classes</title>
...
<body>
        ...
        <section id="about" class="about" style="margin-top: 100px;">
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-header">
                    ...
                    <h2><strong> API Building and Implementation Classes</strong></h2>
    ...
    <ul style="list-style-type: none;">
        <li><p> Redux and Redux toolkits</p></li>
        <li><p> API Implementation with Axios </p></li>
        <li><p> JSON </p></li>
    ...
    <ul style="list-style-type: none;">
        ...
        <li><p>Remote Classes: ₦40,000 </p></li>
        <li><p>Private Classes: ₦90,000 </p></li>
    </ul>
